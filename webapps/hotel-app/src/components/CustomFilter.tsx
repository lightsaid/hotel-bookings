        ...
        <div className=" top-16 w-full max-w-sm px-4">
            <Popover className="relative">
                {({ open }) => (
                    <>
                        <Popover.Button
                            className={`w-[220px] h-[50px] relative border cursor-pointer border-slate-500  box-border
                                    ...
                                    <li className="py-3">
                                        ...
                                        <div className="flex justify-between mt-3">
                                            ...
                                            <div>
                                                <Button
                                                    size="sm"
                                                    className="bg-transparent hover:bg-transparent hover:border-sky-500 px-2 py-1 text-sm"
                                                >
                                                    <AiOutlineMinus className=" text-slate-600" />
                                                </Button>
                                                <span className="text-base text-slate-600 px-2">
                                                    2
                                                </span>
                                                <Button
                                                    size="sm"
                                                    className="bg-transparent hover:bg-transparen hover:border-sky-500  px-2 py-1 text-sm"
                                                >
