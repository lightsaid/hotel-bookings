                ...
                {({ open }) => (
                    <>
                        <Popover.Button
							...
							bg-orange-700 px-3 py-2 text-base font-medium text-white 
                                    ...
                                    <div className="relative grid gap-8 bg-white p-7 lg:grid-cols-2">
                                        {solutions.map((item) => (
                                            <a
												...
												ease-in-out hover:bg-gray-50 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 
